...
function main(args) {
    ...
    if(args.__ow_path && args.__ow_path.length) {
        ...
        if(parts.length === 3 && parts[1].toLowerCase() === 'books') {
            ...
            //Verifies if the method that the web action was invoked with is a delete.
            if (bookId && bookId != "" && args.__ow_method == "delete") {
                return dbUtils.deleteBook(bookId, dbUrl, dbName)
